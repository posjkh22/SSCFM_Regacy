...
echo
$BENCH_MARK_FOLDER/$BENCH_MARK input_large.pgm output_large.smoothing.pgm -s
$BENCH_MARK_FOLDER/$BENCH_MARK input_large.pgm output_large.edges.pgm -e
$BENCH_MARK_FOLDER/$BENCH_MARK input_large.pgm output_large.corners.pgm -c
$FINAL_OUTPUT/final_output_binary input_large.pgm output_large.smoothing.pgm -s
$FINAL_OUTPUT/final_output_binary input_large.pgm output_large.edges.pgm -e
$FINAL_OUTPUT/final_output_binary input_large.pgm output_large.corners.pgm -c

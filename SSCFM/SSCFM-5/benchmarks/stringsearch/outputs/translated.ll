...
; <label>:7:                                      ; preds = %1
  ...
  %12 = call i8* @realloc(i8* %9, i64 %11) #7
  br label %13
...
; <label>:18:                                     ; preds = %13
  ...
  %19 = call i32 @atexit(void ()* @bhmi_cleanup) #7
  br label %20
...
; <label>:21:                                     ; preds = %39, %20
  ...
  %23 = load i32, i32* @patlen.1, align 4
...
; <label>:60:                                     ; preds = %55
  ...
  %71 = getelementptr inbounds [256 x i32], [256 x i32]* @skip.3, i64 0, i64 %70
  store i32 %64, i32* %71, align 4
  %72 = load i32, i32* @patlen.1, align 4
  %73 = load i32, i32* %3, align 4
  %74 = sub nsw i32 %72, %73
  %75 = sub nsw i32 %74, 1
  %76 = load i8*, i8** @pat.2, align 8
  %77 = load i32, i32* %3, align 4
  %78 = sext i32 %77 to i64
  %79 = getelementptr inbounds i8, i8* %76, i64 %78
  %80 = load i8, i8* %79, align 1
  %81 = zext i8 %80 to i32
  %82 = call i32 @tolower(i32 %81) #6
  br label %83

; <label>:83:                                     ; preds = %60
  call void @enqueue_signature(i32 262163)
  %84 = sext i32 %82 to i64
  %85 = getelementptr inbounds [256 x i32], [256 x i32]* @skip.3, i64 0, i64 %84
...
; <label>:89:                                     ; preds = %55
  ...
  %99 = getelementptr inbounds [256 x i32], [256 x i32]* @skip.3, i64 0, i64 %98
  store i32 32767, i32* %99, align 4
  %100 = load i32, i32* %4, align 4
  %101 = call i32 @tolower(i32 %100) #6
  br label %102

; <label>:102:                                    ; preds = %89
  call void @enqueue_signature(i32 262166)
  %103 = sext i32 %101 to i64
  %104 = getelementptr inbounds [256 x i32], [256 x i32]* @skip.3, i64 0, i64 %103
  store i32 32767, i32* %104, align 4
  %105 = load i32, i32* @patlen.1, align 4
  store i32 %105, i32* @skip2.4, align 4
  store i32 0, i32* %3, align 4
  br label %106
...
; <label>:106:                                    ; preds = %126, %102
  ...
  %108 = load i32, i32* @patlen.1, align 4
...
; <label>:120:                                    ; preds = %111
  ...
  %121 = load i32, i32* @patlen.1, align 4
  %122 = load i32, i32* %3, align 4
  %123 = sub nsw i32 %121, %122
  %124 = sub nsw i32 %123, 1
  store i32 %124, i32* @skip2.4, align 4
  br label %125
...
; <label>:126:                                    ; preds = %125
  call void @enqueue_signature(i32 262171)
...
; <label>:129:                                    ; preds = %106
  call void @enqueue_signature_with_return(i32 262172)
  ret void
}
...
; <label>:2:                                      ; preds = %0
  call void @enqueue_signature_with_return(i32 458754)
  ret void
}
...
; <label>:78:                                     ; preds = %75
  call void @enqueue_signature(i32 786448)
  %79 = load i8*, i8** %8, align 8
  store i8* %79, i8** %3, align 8
  br label %87

; <label>:80:                                     ; preds = %75
  call void @enqueue_signature(i32 786449)
...
; <label>:85:                                     ; preds = %80
  call void @enqueue_signature(i32 786450)
  store i8* null, i8** %3, align 8
  br label %87

; <label>:86:                                     ; preds = %80
  call void @enqueue_signature(i32 786451)
  br label %21

; <label>:87:                                     ; preds = %85, %78, %40, %15
  call void @enqueue_signature_with_return(i32 786452)
...
; <label>:76:                                     ; preds = %53
  call void @enqueue_signature_with_return(i32 851984)
  ret void
}
...
; <label>:76:                                     ; preds = %73
  call void @enqueue_signature(i32 917519)
  %77 = load i8*, i8** %8, align 8
  store i8* %77, i8** %3, align 8
  br label %85

; <label>:78:                                     ; preds = %73
  call void @enqueue_signature(i32 917520)
...
; <label>:83:                                     ; preds = %78
  call void @enqueue_signature(i32 917521)
  store i8* null, i8** %3, align 8
  br label %85

; <label>:84:                                     ; preds = %78
  call void @enqueue_signature(i32 917522)
  br label %21

; <label>:85:                                     ; preds = %83, %76, %40, %15
  call void @enqueue_signature_with_return(i32 917523)
...
; <label>:36:                                     ; preds = %18
  call void @enqueue_signature_with_return(i32 983050)
...
; <label>:40:                                     ; preds = %37
  ...
  %49 = call i32 @strncmp(i8* %41, i8* %47, i64 %48) #6
  br label %50
...
; <label>:54:                                     ; preds = %50
  call void @enqueue_signature(i32 1048589)
...
; <label>:57:                                     ; preds = %54
  call void @enqueue_signature(i32 1048590)
  br label %58

; <label>:58:                                     ; preds = %57, %37
  call void @enqueue_signature(i32 1048591)
  br label %13

; <label>:59:                                     ; preds = %13
  call void @enqueue_signature(i32 1048592)
  store i8* null, i8** %2, align 8
  br label %60

; <label>:60:                                     ; preds = %59, %52
  call void @enqueue_signature_with_return(i32 1048593)
...
; <label>:11:                                     ; preds = %9
  ...
  %12 = call i32 @gettimeofday(%struct.timeval* %5, %struct.timezone* null) #7
  br label %13
...
; <label>:20:                                     ; preds = %14
  call void @enqueue_signature_with_call(i32 1179654)
...
; <label>:25:                                     ; preds = %20
  call void @enqueue_signature_with_call(i32 1179655)
...
; <label>:37:                                     ; preds = %35
  ...
  %38 = call i32 @gettimeofday(%struct.timeval* %6, %struct.timezone* null) #7
  br label %39

; <label>:39:                                     ; preds = %37
  call void @enqueue_signature(i32 1179660)
...
; <label>:53:                                     ; preds = %39
  call void @enqueue_signature_with_remainder_process(i32 1179661)

...
.LBB4_16:                               #   in Loop: Header=BB4_3 Depth=1
	...
	jl	.LBB4_18
# BB#17:
	movl	$786450, %edi           # imm = 0xC0012
	callq	enqueue_signature
	movq	$0, -48(%rbp)
	jmp	.LBB4_19
.LBB4_18:                               #   in Loop: Header=BB4_3 Depth=1
	movl	$786451, %edi           # imm = 0xC0013
	callq	enqueue_signature
	jmp	.LBB4_3
.LBB4_19:
	movl	$786452, %edi           # imm = 0xC0014
	callq	enqueue_signature_with_return
	movq	-48(%rbp), %rax
	addq	$48, %rsp
	popq	%rbx
...
.LBB6_15:                               #   in Loop: Header=BB6_3 Depth=1
	...
	jl	.LBB6_17
# BB#16:
	movl	$917521, %edi           # imm = 0xE0011
	callq	enqueue_signature
	movq	$0, -48(%rbp)
	jmp	.LBB6_18
.LBB6_17:                               #   in Loop: Header=BB6_3 Depth=1
	movl	$917522, %edi           # imm = 0xE0012
	callq	enqueue_signature
	jmp	.LBB6_3
.LBB6_18:
	movl	$917523, %edi           # imm = 0xE0013
	callq	enqueue_signature_with_return
	movq	-48(%rbp), %rax
	addq	$48, %rsp
	popq	%rbx
...
# BB#13:                                #   in Loop: Header=BB8_2 Depth=1
	movl	$1048590, %edi          # imm = 0x10000E
	callq	enqueue_signature
.LBB8_14:                               #   in Loop: Header=BB8_2 Depth=1
	movl	$1048591, %edi          # imm = 0x10000F
	callq	enqueue_signature
	jmp	.LBB8_2
.LBB8_15:
